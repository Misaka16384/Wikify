...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      cfg_f_search_kbs: "这个项目的搜索还会读哪几个已注册的库。留空 = 只搜本库。注册表里的「可搜索」勾是全机的,说的是某个库允不允许被别处读到;这里说的是本项目实际读哪几个。",
    ...
    en: {
      ...
      cfg_f_search_kbs: "Which other registered libraries this project's searches reach. Empty means just this one. The registry's Searchable tick is machine-wide and says whether a library may be read at all; this says which ones this project actually reads.",
  ...
  const CFG_LABEL_KEYS = {
    ...
    "research.search_kbs": "cfg_f_search_kbs",
