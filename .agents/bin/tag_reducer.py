...
# Add parent dir to path to import from llm-wiki
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
try:
    from bin.__init__ import __name__  # just to test import
except ImportError:
    pass
...
def replace_yaml_list(text: str, field: str, new_list: list) -> str:
    ...
    # Regex to find existing field (either inline [a,b] or block list)
