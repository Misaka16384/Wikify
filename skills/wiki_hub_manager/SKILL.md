...
4. **Restore an Archived Topic**
   ...
   `magi hub restore --hub <path_to_hub> <slug>`
...
5. **Register an Existing Active Topic**
   ...
   `magi hub register --hub <path_to_hub> <slug> --description "<Topic Title>"`
